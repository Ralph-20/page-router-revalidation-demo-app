...
export default function DemoPage2({ randomNumber, backgroundColor, timestamp }: DemoPageProps) {
  return (
    <div 
    ...
    >
      <div className="bg-white rounded-lg shadow-2xl p-12 max-w-2xl w-full text-center">
        <h1 className="text-4xl font-bold mb-8 text-gray-800">Demo Page 2</h1>
